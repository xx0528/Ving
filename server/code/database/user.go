...
func (d *MovieDatabase) GetUsers(paging *model.Paging) []*model.User {
	users := []*model.User{}
...
func (d *MovieDatabase) CreateUser(user *model.User) error {
...
func (d *MovieDatabase) GetUserByName(name string) *model.User {
	var user *model.User
...
func (d *MovieDatabase) GetUserByIDs(ids []primitive.ObjectID) []*model.User {
...
func (d *MovieDatabase) CountUser() string {
...
func (d *MovieDatabase) DeleteUserByID(id primitive.ObjectID) error {
